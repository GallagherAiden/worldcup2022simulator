...
function selectRandom1() {
	...
	for (i = 0; i < team1players.length; i++) {
		if (team1players[i].position === "GK") {
			allGK.push(i);
		} else if (team1players[i].position === "CB" || team1players[i].position === "LB" || team1players[i].position === "RB" || team1players[i].position === "RWB" || team1players[i].position === "LWB" || team1players[i].position === "RCB" || team1players[i].position === "LCB") {
			allDEF.push(i);
		} else if (team1players[i].position === "CM" || team1players[i].position === "CDM" || team1players[i].position === "CAM" || team1players[i].position === "RM" || team1players[i].position === "LM" || team1players[i].position === "LCM" || team1players[i].position === "RCM" || team1players[i].position === "LDM" || team1players[i].position === "RDM") {
			allMID.push(i);
...
function selectRandom2() {
	...
	for (i = 0; i < team2players.length; i++) {
		if (team2players[i].position === "GK") {
			allGK.push(i);
		} else if (team2players[i].position === "CB" || team2players[i].position === "LB" || team2players[i].position === "RB" || team2players[i].position === "RWB" || team2players[i].position === "LWB" || team2players[i].position === "RCB" || team2players[i].position === "LCB") {
			allDEF.push(i);
		} else if (team2players[i].position === "CM" || team2players[i].position === "CDM" || team2players[i].position === "CAM" || team2players[i].position === "RM" || team2players[i].position === "LM" || team2players[i].position === "LCM" || team2players[i].position === "RCM" || team2players[i].position === "LDM" || team2players[i].position === "RDM") {
			allMID.push(i);
...
function getTeamJSON(f, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, team) {
	...
	http.onreadystatechange = function () {
		if (this.readyState === 4 && this.status === 200) {
			var result = JSON.parse(this.responseText);
			if (result.name.toLowerCase() === team1json.name.toLowerCase()) {
				team1json = result;
			} else if (result.name.toLowerCase() === team2json.name.toLowerCase()) {
				team2json = result;
			}
		}
	};
